...
gym.register(
    id="reward_preprocessing/DummyMountainCar-v0",
...
def mountain_car(**kwargs):
    ...
    env = util.make_env_no_wrappers(
        "reward_preprocessing/DummyMountainCar-v0", **kwargs
    )
...
gym.register(
    id="reward_preprocessing/MountainCar-v0",
